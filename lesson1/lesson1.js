...
function setSounds(){
    ...
    //第一音と第二音を取得
    lesson1.setPrimaryKeys(formStatus.type)
    first = lesson1.getInitSound(formStatus.intervals,formStatus.direction);
    second = lesson1.getNextSound(first,formStatus.intervals,formStatus.direction);
    console.log(first);
    console.log(second);
